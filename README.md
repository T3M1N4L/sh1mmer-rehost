![SH1MMER (light)](/public/sh1mmer/assets/sh1mmer_light_banner.png#gh-dark-mode-only)
![SH1MMER (dark)](/public/sh1mmer/assets/sh1mmer_dark_banner.png#gh-light-mode-only)
